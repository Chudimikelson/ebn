...
export default function Advrt() {
  return (
    <section className="bg-light mt-n5"><Acads>
                  ...
                  <div className="row text-center text-md-left ">
                    <div className="col-12 col-md-6 d-md-flex bootcamp">
                      <div className="col-md-6 py-3">
                        <div className="mb-3 text-contrast lead">Etoile Skincare Training</div>
                    ...
                    <div className="col-12 col-md-6 d-md-flex mini-course">
                      <div className="col-12 col-md-6 py-3">
                        <div className="mb-3 text-brand tenali font-md">Beginners' Guide eBook</div>
                        <h4 className="text-body">Purchase our step-by-step guide to making natural skincare products</h4>
                        <p className="text-body">We have made this guide so simple that you can start to make your own products in less than 7 days.</p>
                      </div>
                      <div className="col-12 col-md-6 my-auto">
                        <img src={minicourse} alt="etoile academy" className="image-responsive course-img"/>
                        <div><a className="no-decor-links" href="https://bit.ly/3j9sAwd" target="_blank" rel="noopener noreferrer"><button className="btn btn-success my-3">Buy Now</button></a>
                          </div>
                      </div>
                    </div>
                  </div>
