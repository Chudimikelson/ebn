      ...
      <ProductConsumer>
        {(value) => {
          ...
          const cartItems = cart.map(
            (cartItem) => cartItem.count + ' ' + cartItem.title
          )
                  ...
                  <section className='cert-header paddit'>
                    <div className='container '>
                      <div className='col-md-10'>
                        ...
                        <h2 className='h1 text-contrast'>
                          <span className='mr-1'>&#8358;</span>
                          {cartTotal}
                          <small>.00</small>
                        </h2>
                        <p className='mb-0 text-light'>
                          Please fill your Shipping Details and proceed to
                          Payment
                        </p>
                      </div>
                    </div>
                            ...
                            <div class='card-body'>
                              ...
                              <div class='card'>
                                <div class='card-header'>
                                  <button
                                    className='card-title btn bold'
                                    data-toggle='collapse'
                                    data-target='#clp-promo'
                                  >
                                    ...
                                    >
                                      ...
                                      <div className='form-group'>
                                        ...
                                        <textarea
                                          ...
                                          placeholder='Your Address, 1234 Your Street, Your City'
                                          rows='4'
                                          required=''
                                        ></textarea>
                                      </div>
                              ...
                              <div className='d-flex flex-wrap text-capitalize justify-content-between'>
                                <p className='bold text-darker text-capitalize'>
                                  sub total
                                </p>
                                <p className='bold price ml-sm-auto'>
                                  <span className='mr-1'>&#8358;</span>{' '}
                                  {cartSubTotal}{' '}
                                </p>
                              </div>
                              ...
                              <div className='d-flex flex-wrap text-capitalize justify-content-between'>
                                <p className='text-capitalize bold text-darker'>
                                  Shipping fee:{' '}
                                </p>
                                <p className='bold price ml-sm-auto'>
                                  <span className='mr-1'>&#8358;</span>
                              ...
                              <div class='d-flex flex-wrap justify-content-between'>
                                <p class='bold text-darker text-uppercase'>
                                  Total
                                </p>
                                <p class='h5 bold price ml-sm-auto'>
                                  <span>&#8358;</span> {cartTotal}{' '}
                                </p>
                              </div>
                              {/** Proceed  */}
                              <div className='card'>
                                <div className='card-header'>
                                  <p className='card-title btn bold'>
