...
export default function ShopByCategories() {
  return (
    <Sbc>
      <div className='shadow-box px-sm-6 py-sm-5 row mx-auto'>
        <div class='col-12 p-2'>
          <span class='text-brand bold'>Discover</span>
        ...
        <div className='col-md-6 col-sm-6 col-lg-6'>
          <img
            className='shadow-hover img-responsive'
            style={{ height: 400 }}
            src={catPic2}
          ...
          <Link to='/shop'>
            <div className='finess mx-auto'>
              <button className='py-1 text-capitalize text-light'>
                Shop All
              </button>
            </div>{' '}
          </Link>
        ...
        <div className=' col-md-6 col-sm-6 col-lg-6'>
          <img
            className='shadow-hover img-responsive'
            alt='Natural Lightening and skin brightening lotions and creams'
            style={{ height: 400 }}
            src={catPic1}
          />
          <Link to='/collections'>
