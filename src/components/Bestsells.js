          ...
          return (
            <EmptyWrapper className='container d-flex flex-wrap paddit'>
              <div className='col-12 col-lg-4 mt-5'>
                <h2 className='page-title text-center font-weight-bold mb-0'>
                  {title}
                </h2>
                <img
                  src={img}
                  className='mx-auto card img-fluid'
                  alt='product'
                />
              ...
              <div className='col-12 col-lg-8 page-title mt-md-5'>
                ...
                <button
                  className='cart-btn text-center text-tit py-0 px-0 my-2'
                ...
                >
                  {inCart ? (
                    <p
                      className='mx-auto ic text-capitalize text-center py-2 mb-0'
                      disabled
                    >
                      Item added
                    </p>
                ...
                <Link to='/shop'>
                  <button className='cart-btn text-center py-0 px-0 my-2'>
                    <p className='mx-auto py-2 btc mb-0'>Back to Products</p>
                  </button>
                </Link>
              </div>
            </EmptyWrapper>
