      ...
      <ExpansionPanel square expanded={expanded === 'panel2'} onChange={handleChange('panel2')}>
        ...
        <ExpansionPanelDetails>
          <div className="pt-2">
              ...
              <p className="text-left"><i className="fas fa-flask text-contrast px-3"></i><a target="_blank" rel="noopener noreferrer" href="https://wa.me/2348142195884" className="no-decor-links text-contrast">Create Your Own</a>
              </p>
              ...
              <p className="text-left"><i className="fas fa-magic text-contrast px-3"></i><a target="_blank" rel="noopener noreferrer" href="https://wa.me/2348142195884" className="no-decor-links text-contrast">Customize your Collection</a>
              </p>
              <p className="text-left"><i className="fas fa-truck-loading text-contrast px-3"></i><a target="_blank" rel="noopener noreferrer" href="https://wa.me/2348142195884" className="no-decor-links text-contrast">Bulk Order</a>
              </p>
              <p className="text-left"><i className="fas fa-people-carry text-contrast px-3"></i><a target="_blank" rel="noopener noreferrer" href="https://wa.me/2348142195884" className="no-decor-links text-contrast">Be a Stockist</a>
              </p>
          </div>
        </ExpansionPanelDetails>
      </ExpansionPanel>
